                                ...
                                <div id="content">
                                    <ul class="timeline">
                                        <li class="event" data-date="Aug 2023 - Present">
                                            ...
                                            <p style={{ fontSize: '15px', marginBottom: '10px', color: 'rgba(100, 100, 100, 0.6)' }}>Redbytes Software Pvt Ltd</p>
                                            <p style={{ marginBottom: '10px' }}>
                                                Skill : Node.js · Socket.IO · MQTT
                                            </p>
                                            <p>
                                        ...
                                        <li class="event" data-date="Nov 2021 – Apr 2023 ">
                                            ...
                                            <p style={{ marginBottom: '10px' }}>
                                                Skill :  REST APIs · Laravel · Node.js · MySQL
                                            </p>
                                            <p>
                                        ...
                                        {/* <li class="event" data-date="May 2022 - Nov 2022">
                                            ...
                                            <p style={{ marginBottom: '10px' }}>
                                                Skill :  J meter · Software Testing · Selenium
                                            </p>
                                            <p>
